...
J1_ERCC <- readRDS("Data/J1_ERCC.rds")
...
# Calculate mRNA content from ERCCs ---------------------------------------
...
# Figure 4b: UMI detection vs mRNA content --------------------------------
